...
const Banner = () => {
  return (
    <section className="relative min-h-[85svh] md:min-h-[90vh] flex items-center px-4 pt-24 pb-12">
      {/* 1. Background Container with the Crumbworks Shape */}
      <div
        className="
          absolute inset-4 z-0 overflow-hidden
